from classroom_notice_board_rest_clinet.restclient import update_poster, get_first_value_by_event, update_team
import random
...
def test_update_team():
    ...
    fake = Faker(['ko_KR'])
    status_code = update_team(widgets_id="oneTeam", label=fake.name(), value=fake.job())
